...
from .views import BlogListView,BlogDetailView,BlogCreateView,BlogUpdateView,BlogDeleteView,BlogHomeView,SearchResultListView,postlikes,post_comment,post_list
